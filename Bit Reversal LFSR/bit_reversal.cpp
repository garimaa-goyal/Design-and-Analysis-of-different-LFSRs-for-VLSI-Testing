...
int main() {
    ...
    bitset<4> reg_q(1100); // reg_q initialising value is different here
    bitset<4> q;
    bool out, e, f;
    ...
    for (int i = 0; i < numIterations; ++i) {
        ...
        if (rst) {
            ...
            shiftedBits[3] = reg_q[2]; 
            shiftedBits[2] = reg_q[1];  
            shiftedBits[1] = reg_q[0]; 
            shiftedBits[0] = reg_q[3]^reg_q[2]^reg_q[1]; 
